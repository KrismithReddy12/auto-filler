    ...
    async startScenarioPlayback(scenario, playbackSpeed, tabId) {
      ...
      async continuePlayback() {
        ...
        console.log(`Executing action ${currentIndex + 1}/${scenario.length}:`, action.type);        try {
            ...
            const maxAttempts = playbackSpeed === 'instant' ? 20 : (playbackSpeed === 'fast' ? 15 : 10);
            const checkInterval = playbackSpeed === 'instant' ? 50 : (playbackSpeed === 'fast' ? 75 : 100);
            const initialDelay = playbackSpeed === 'instant' ? 25 : (playbackSpeed === 'fast' ? 40 : 50);
